...
class PointCloudStitcher:
    ...
    def transform_points(self, points, transform):
        ...
        # Shift the points down by 2 meters (adjust this value as needed)
        #shift = np.array([0, 0, -1.125])  # Negative z-axis is downward
        #transformed_points += shift
    ...
    def icp_registration(self, source_pcd, target_pcd, initial_guess=np.eye(4)):
        threshold = 0.15  # Distance threshold for ICP
